...
static void logo_anim_start()
{
    ...
    lv_obj_set_style_bg_color(block,  lv_color_hex(0xf5f5f5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(block, lv_color_hex(0xf5f5f5), LV_PART_MAIN | LV_STATE_DEFAULT);
